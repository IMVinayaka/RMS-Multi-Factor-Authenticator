...
const LoginWrapper = ({ logo, flag, gradientColor,bgImage, children,aboutus,privacyAndTerms }) => {
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center max-w-5xl h-full  rounded-lg   border border-white/40 ">
    {/* Header */}
      <div   style={{
        overflow: 'hidden',
      ...
      <div className="relative w-full flex justify-center items-center p-8">
        ...
        {/* Form box */}
        <div className="relative bg-white/20 border border-white/40 rounded-lg p-8 shadow-lg w-full max-w-md">
          {children}
        </div>
      </div>
